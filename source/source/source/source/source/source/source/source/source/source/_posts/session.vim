...
map ,,y "+p
vnoremap ,y "+y
nnoremap <silent> ,tt :execute 'tabnext ' . g:last_active_tab
noremap ,0 :tablast
noremap ,9 9gt
noremap ,8 8gt
noremap ,7 7gt
...
noremap ,h :GundoToggle
nnoremap ,gs :GitGutterToggle
nnoremap ,ge :Gdiff
...
nnoremap <silent> ,ec :SyntasticToggleMode
...
nnoremap <F6> :exec exists('syntax_on') ? 'syn off' : 'syn on'
nnoremap <F4> :set wrap! wrap?
nnoremap <F3> :set list! list?
nnoremap <F2> :call HideNumber()
noremap <F1> "
map <Down> <Nop>
map <Up> <Nop>
noremap <Right> :bn
...
cnoremap <NL> <Down>
inoremap <NL> =g:JInYCM()
inoremap <silent>  =g:KInYCM()
cnoremap  <Up>
inoremap <expr>  pumvisible() ? "\" : "\"
imap  <Plug>Isurround
inoremap  :tabnew
...
set shortmess=aoO
badd +7 MyJob/nt2000中转器程序流程设计.md
badd +5 MyJob/调试问题记录.md
badd +0 Learning/Python/linux实时屏幕按键显示.md
badd +22 Learning/Python/pip——python扩展包安装卸载等管理.md
badd +0 ~/.vimrc
argglobal
silent! argdel *
$argadd source/_posts/MyJob/
edit ~/.vimrc
...
exe 'vert 2resize ' . ((&columns * 31 + 68) / 136)
exe '3resize ' . ((&lines * 14 + 18) / 37)
exe 'vert 3resize ' . ((&columns * 53 + 68) / 136)
exe '4resize ' . ((&lines * 14 + 18) / 37)
exe 'vert 4resize ' . ((&columns * 50 + 68) / 136)
argglobal
edit ~/.vim/bundle/vimdoccn/doc/windows.cnx
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal formatexpr=
setlocal formatoptions=mBtcroql
...
silent! normal! zE
let s:l = 464 - ((12 * winheight(0) + 10) / 20)
...
nnoremap <buffer> <silent> gv :call nerdtree#ui_glue#invokeKeyMap("gv")
...
nnoremap <buffer> <silent> t :call nerdtree#ui_glue#invokeKeyMap("t")
nnoremap <buffer> <silent> u :call nerdtree#ui_glue#invokeKeyMap("u")
nnoremap <buffer> <silent> v :call nerdtree#ui_glue#invokeKeyMap("v")
nnoremap <buffer> <silent> x :call nerdtree#ui_glue#invokeKeyMap("x")
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 403 - ((7 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
403
...
setlocal filetype=markdown.mkd
endif
setlocal fixendofline
setlocal foldcolumn=0
setlocal foldenable
...
setlocal foldtext=foldtext()
setlocal formatexpr=
setlocal formatoptions=mBtcqln
...
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'markdown.mkd'
setlocal syntax=markdown.mkd
endif
setlocal tabstop=4
setlocal tagcase=
setlocal tags=
...
exe '4resize ' . ((&lines * 14 + 18) / 37)
exe 'vert 4resize ' . ((&columns * 50 + 68) / 136)
tabedit Learning/Python/pip——python扩展包安装卸载等管理.md
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit Learning/Python/linux实时屏幕按键显示.md
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
