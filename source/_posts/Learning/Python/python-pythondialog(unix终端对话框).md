---
title: python-dialog(unix显示终端对话框)
date: 2017-06-10 21:48:16
tags:
- Python
- pythondialog
categories:
...
# python-dialog(unix显示终端对话框)

## 参考

[主页：https://pypi.python.org/pypi/pythondialog/](https://pypi.python.org/pypi/pythondialog/)
[使用文档：http://pythondialog.sourceforge.net/doc/](http://pythondialog.sourceforge.net/doc/)

## 简介

一个python界面应用与UNIX对话框框功能,兼容大部分程序
...
def textbox_demo(d):
    ...
    d.textbox("demo.txt", width=76)
```

### 输入对话框，获取输入信息-inputbox
```
def inputbox_demo(d):
...
def main():
    ...
    try:
        demo()
    except dialog.errora as exc_instance:
